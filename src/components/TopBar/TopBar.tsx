            ...
            <Menu text=" ≡ " hotkeyPos={[1]} bX={1} open={activeMenu == 0} onClick={(event) => toggleMenu(0, event)}>
                <SubMenu
                    ...
                    entries={[
                        ...
                        { text: "Turbo Assembler", hotkeyPos: 0, action: () => tasmOpen(dispatch) },
                        { text: "Turbo Debugger ", hotkeyPos: 6, action: () => tdOpen(dispatch) },
                        { text: "Turbo Profiler ", hotkeyPos: 6, action: () => tpOpen(dispatch) },
                    ]}
                />
            </Menu>
            <div style={{
                ...
                <Menu text=" Search " hotkeyPos={[1]} bX={16} open={activeMenu == 3} onClick={(event) => toggleMenu(3, event)}>
                    <SubMenu
                        ...
                        entries={[
                            ...
                            { text: "Previous error     Alt+F7", hotkeyPos: 0, disabled: true },
                            { text: "Next error         Alt+F8", hotkeyPos: 0, disabled: true },
                            { text: "Locate function...       ", hotkeyPos: 0, disabled: true },
                        ]}
                    />
                </Menu>
                <Menu text=" Run " hotkeyPos={[1]} bX={24} open={activeMenu == 4} onClick={(event) => toggleMenu(4, event)}>
                    <SubMenu
                        ...
                        entries={[
                            ...
                            { text: "Program reset   Ctrl+F2", hotkeyPos: 0, disabled: true },
                ...
                <Menu text=" Compile " hotkeyPos={[1]} bX={29} open={activeMenu == 5} onClick={(event) => toggleMenu(5, event)}>
                    <SubMenu
                        ...
                        entries={[
                            ...
                            { text: "Remove messages       ", hotkeyPos: 0, disabled: true },
                        ]}
                    />
                </Menu>
                <Menu text=" Debug " hotkeyPos={[1]} bX={38} open={activeMenu == 6} onClick={(event) => toggleMenu(6, event)}>
                    <SubMenu
                        ...
                        entries={[
                            ...
                            { text: "Call stack...         Ctrl+F3", hotkeyPos: 0, disabled: true },
                ...
                <Menu text=" Project " hotkeyPos={[1]} bX={45} open={activeMenu == 7} onClick={(event) => toggleMenu(7, event)}>
                    <SubMenu
                        ...
                        entries={[
                            ...
                            { text: "Close project   ", hotkeyPos: 0, disabled: true },
                            "separator",
                            { text: "Add item...     ", hotkeyPos: 0, disabled: true },
                            { text: "Delete item     ", hotkeyPos: 0, disabled: true },
                            { text: "Local options...", hotkeyPos: 0, disabled: true },
                            { text: "Include files...", hotkeyPos: 0, disabled: true },
                        ]}
                    />
                </Menu>
                ...
                <Menu text=" Window " hotkeyPos={[1]} bX={65} open={activeMenu == 9} onClick={(event) => toggleMenu(9, event)}>
                    <SubMenu
                        ...
                        height={19}
                        entries={[
                            { text: "Size / Move     Ctrl+F5", hotkeyPos: 0 },
                            { text: "Zoom                 F5", hotkeyPos: 0 },
                            { text: "Tile                   ", hotkeyPos: 0 },
                            { text: "Cascade                ", hotkeyPos: 1 },
                            { text: "Next                 F6", hotkeyPos: 2 },
                            { text: "Close            Alt+F3", hotkeyPos: 1 },
                            { text: "Close all              ", hotkeyPos: 4 },
                            "separator",
                            { text: "Message                ", hotkeyPos: 0 },
                            { text: "Output                 ", hotkeyPos: 0 },
                            { text: "Watch                  ", hotkeyPos: 0 },
                            { text: "User Screen      Alt+F5", hotkeyPos: 0 },
                            { text: "Register               ", hotkeyPos: 0 },
                            { text: "Project                ", hotkeyPos: 0, disabled: true },
                            { text: "Project notes          ", hotkeyPos: 0, disabled: true },
                            "separator",
                            { text: "List all...       Alt+0", hotkeyPos: 0},
                        ]}
                    />
                </Menu>
                <Menu text=" Help  " hotkeyPos={[1]} bX={73} open={activeMenu == 10} onClick={(event) => toggleMenu(10, event)}>
                    <SubMenu
                        ...
                        height={9}
                        entries={[
                            { text: "Contents                 ", hotkeyPos: 0 },
                            { text: "Index            Shift+F1", hotkeyPos: 0 },
                            { text: "Topic search      Ctrl+F1", hotkeyPos: 0 },
                            { text: "Prevous topic      Alt+F1", hotkeyPos: 0 },
                            { text: "Help on help             ", hotkeyPos: 0 },
                            "separator",
                            { text: "About...                 ", hotkeyPos: 0, action: () => aboutOpen(dispatch) },
                        ]}
                    />                            
                </Menu>
            </div>
